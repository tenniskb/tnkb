...
<div class="pocket-card-title">DD1 CARD — THE PLAYER IN MOTION</div>

<div class="pocket-card-section">
<strong>🎯 ONE BIG IDEA</strong>
<p>Stroke quality is GEOMETRY, not strength. Six joint angles at contact determine pace and safety. Get the angles right, the strength follows.</p>
</div>

<div class="pocket-card-section">
<strong>KEY ANGLES</strong>
<ul>
<li>Knee LOADED 60–70° (not 30° standing, not 90° lunge)</li>
<li>Hip rotation 40–45° at contact</li>
<li>Shoulder 90–100° abduction in scapular plane</li>
<li>Elbow 90–100° (natural pendulum, NOT 70° snap-out)</li>
<li>Wrist 5–15° extension at CONTACT (NOT 110° snap)</li>
<li>Arm 45° away from trunk (NOT tight to body)</li>
</ul>
</div>

<div class="pocket-card-section">
<strong>⚠️ TOP MISTAKE</strong>
<p>Freezing the LOADED wrist position and trying to hit through it. The LOADED position is 90–110° wrist extension. The CONTACT position is 0–20°. These are TWO DIFFERENT positions. The whip is the 0.2-second transition between them.</p>
</div>

<div class="pocket-card-section">
<strong>🔁 DRILL</strong>
<p>"Drop first" drill: ready position, friend yells "ball!", drop into LOAD position in 1 second. If your racquet goes back BEFORE your knee bends, reset. Do 10 reps before each session.</p>
</div>

<div class="pocket-card-section">
<strong>💭 MASTER CUE</strong>
<p>"Drop the knee, the hip will follow."</p>
</div>
...
| Description | Image |
| --- | --- |
| Thoracic cage — protective shield around heart and lungs | ![Giai Phau Tennis Toan Dien  img04](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img04.png) |
| Intercostal muscles — lifting ribs | ![Giai Phau Tennis Toan Dien  img05](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img05.png) |
| Bucket-handle rotation — ribs lifting outward | ![Giai Phau Tennis Toan Dien  img06](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img06.png) |
...
| Description | Image |
| --- | --- |
| Semi-open stance loading — shoulder rotated away from hip | ![Giai Phau Tennis Toan Dien  img13](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img13.png) |
| Forward weight shift (Nadal example) — weight transfers without stepping | ![Giai Phau Tennis Toan Dien  img14](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img14.png) |
| Rotation from trunk — force from obliques and thorax | ![Giai Phau Tennis Toan Dien  img15](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img15.png) |

### Figure 6 — The 45° Contact Rule (Pro vs Amateur)

| Description | Image |
| --- | --- |
| 45° angle — arm far from trunk creates optimal lever | ![Giai Phau Tennis Toan Dien  img16](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img16.png) |
| BEFORE (amateur) — arm too bent, too close, lost lever | ![Giai Phau Tennis Toan Dien  img17](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img17.png) |
| Djokovic example — contact in front of body, no wrist snap | ![Giai Phau Tennis Toan Dien  img18](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img18.png) |

### Figure 7 — The Backswing Pro Secret

| Description | Image |
| --- | --- |
| Abduct elbow back — stretching pec major and anterior deltoid | ![Giai Phau Tennis Toan Dien  img19](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img19.png) |
| 5:30 position — hand level with hip, racket head up | ![Giai Phau Tennis Toan Dien  img20](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img20.png) |
| Racket flip effortless — flip from elastic recoil | ![Giai Phau Tennis Toan Dien  img21](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img21.png) |

### Figure 8 — Acceleration: Legs → Core → Chest

| Description | Image |
| --- | --- |
| Drive legs — knee flexed, push into ground | ![Giai Phau Tennis Toan Dien  img22](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img22.png) |
| Rotate hips — hip opens first, chest follows | ![Giai Phau Tennis Toan Dien  img23](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img23.png) |
