...
**The source document nails this** — *Trước khi muốn [đánh] nó lao đi nhanh chóng, động cơ cần nạp nguyên liệu.* Translation: before you swing, you must LOAD. Before the engine fires, fuel goes in.
...
**Spring 1 — Calf/Achilles (both legs)** load at knee flexion ~130°–140° + heel-up ~60°–70°. Release at takeoff.
...
![Shoulder anatomy - rotator cuff](images/DD2_shoulders/DD2_shoulders_pdf01.jpeg)

**Figure 1 / Figure 1** — The 4 rotator cuff muscles (SITS: supraspinatus, infraspinatus, teres minor, subscapularis). These are the SHOULDERS LIGAMENTS — small but essential.
...
![Subacromial space anatomy](images/DD2_shoulders/DD2_shoulders_pdf04.jpeg)

**Figure 2 / Figure 2** — Subacromial space. Notice the supraspinatus tendon passing through the narrow gap.
...
![Scapular plane positioning](images/DD2_shoulders/DD2_shoulders_pdf07.jpeg)

**Figure 3 / Figure 3** — Scapular plane: the arm reaches forward 30°–40°, not straight lateral. This position opens the subacromial space by ~2 mm.
...
![Cubital tunnel anatomy](images/DD3_arms_wrists_hands/Anatomy_Tay_Than_Kinh_Full__img01.png)

**Figure 4 / Figure 4** — Cubital tunnel at full extension (left) vs at 90° flexion (right). The space shrinks dramatically.
...
![Patellar tendon anatomy](images/DD6_knees/DD6_knees_pdf01.jpeg)

**Figure 5 / Figure 5** — Patellar tendon from quadriceps to tibia. The kneecap (patella) sits embedded in the tendon like a pulley.
...
![Windlass mechanism](images/DD7_ankles_feet/DD7_ankles_feet_04.jpg)

**Figure 6 / Figure 6** — Big-toe extension tightens the plantar fascia like a windlass, raising the arch.
...
The source document you gave me has one of the clearest explanations of muscle-as-spring I have ever read. The author (Tuan_tuan) wrote: *"Bắp cơ của ta - hiểu một cách đơn giản - là gồm một đống sợi dây thun."* Translation: **our muscles, simply put, are a bunch of rubber bands.**
