...
Sai lầm lớn nhất trong tennis là nghĩ rằng nó liên quan đến cơ bắp. Không phải — nó liên quan đến *trương lực*, cái mà người nói tiếng bạn gọi lỏng lẻo là "tone," và cái mà cơ thể bạn thực sự làm trong khoảng không gian giữa nỗ lực và sự dễ dàng.
...
Không có điều nào trong số đó thay đổi nguyên tắc cơ bản của toàn bộ cẩm nang này: cơ thể bạn biết chính nó, bạn là chuyên gia hệ thống, và dữ liệu thông tin — nó không bao giờ sai khiến. Một người chơi với mọi công cụ trong danh sách này mà chưa xây dựng hệ thống riêng của mình sẽ không tốt hơn một người 4.0 không có công cụ nào trong số đó. Vậy nên khi mỗi công cụ mới xuất hiện, hãy tự hỏi mình một câu hỏi: điều này có phục vụ hệ thống của tôi không, hay nó đang cố thay thế hệ thống của tôi? Giữ loại đầu tiên. Từ chối loại thứ hai.
