...
| **What it does NOT cover:** stroke-by-stroke mechanics (Forehand| **Reading time:** 35–45 minutes. |
...
|---|---|---|---|---|
| **1. Split-Step** | Land on both feet as opponent strikes. Coiled-spring loading. |
 ~150 ms | Knees 50–70° flexed, weight on balls of feet, both feet shoulder-width apart. |
| **2. Push** | Explosive first step in direction of ball. Ground reaction force. |
 ~200 ms | Push step knee ~65° (Alcaraz measured angle). Trunk lean forward 15–20°. |
| **3. Recovery** | Return to center after shot. Outside leg bridge. |
 ~400–600 ms | Cross-over shuffle or backpedal. Outside leg angled 30–45° (see DD7 on foot). |
...
|---|---|---|
| Backswing | Posterior deltoid, infraspinatus, teres minor, trapezius, rhomboids, serratus anterior (eccentric) ![DD1_player_in_motion_01.png](images/DD1_player_in_motion/DD1_player_in_motion_01.png) |
| Forward swing | Gastrocnemius, soleus, quadriceps, gluteals, hip rotators (concentric) ![DD1_player_in_motion_02.png](images/DD1_player_in_motion/DD1_player_in_motion_02.png)
| Contact | Anterior deltoid, pectoralis major, subscapularis, wrist extensors ![DD1_player_in_motion_03.png](images/DD1_player_in_motion/DD1_player_in_motion_03.png)
| Follow-through | Posterior deltoid, infraspinatus, teres minor, trapezius (eccentric deceleration) ![DD1_player_in_motion_04.png](images/DD1_player_in_motion/DD1_player_in_motion_04.png)
 Frame | Caption | Image |
|---|---|---|
| 3a (0.0 s) | Push step — hips low, knee ~65° ![Anatomy_Chuyen_Dong__img03.png](images/DD1_player_in_motion/Anatomy_Chuyen_Dong__img03.png)
| 3b (1.2 s) | Short landing — toe under hip ![Anatomy_Chuyen_Dong__img04.png](images/DD1_player_in_motion/Anatomy_Chuyen_Dong__img04.png)
| 3c (3.5 s) | Brake and rotate — trunk opens ![Anatomy_Chuyen_Dong__img05.png](images/DD1_player_in_motion/Anatomy_Chuyen_Dong__img05.png)
 Hình | Description | Image |
|---|---|---|
| 4 | Thoracic cage — protective shield around heart and lungs ![Giai_Phau_Tennis_Toan_Dien__img04.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img04.png)
| 5 | Intercostal muscles — lifting ribs ![Giai_Phau_Tennis_Toan_Dien__img05.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img05.png)
| 6 | Bucket-handle rotation — ribs lifting outward ![Giai_Phau_Tennis_Toan_Dien__img06.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img06.png)
 Hình | Description | Image |
|---|---|---|
| 13 | Semi-open stance loading — shoulder rotated away from hip ![Giai_Phau_Tennis_Toan_Dien__img13.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img13.png)
| 14 | Forward weight shift (Nadal example) — weight transfers without stepping ![Giai_Phau_Tennis_Toan_Dien__img14.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img14.png)
| 15 | Rotation from trunk — force from obliques and thorax ![Giai_Phau_Tennis_Toan_Dien__img15.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img15.png)
...
|
 Description | Image |
|---|---|---|
| 16 | 45° angle — arm far from trunk creates optimal lever ![Giai_Phau_Tennis_Toan_Dien__img16.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img16.png)
| 17 | BEFORE (amateur) — arm too bent, too close, lost lever ![Giai_Phau_Tennis_Toan_Dien__img17.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img17.png)
| 18 | Djokovic example — contact in front of body, no wrist snap ![Giai_Phau_Tennis_Toan_Dien__img18.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img18.png)
...
|
 Description | Image |
|---|---|---|
| 19 | Abduct elbow back — stretching pec major and anterior deltoid ![Giai_Phau_Tennis_Toan_Dien__img19.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img19.png)
| 20 | 5:30 position — hand level with hip, racket head up ![Giai_Phau_Tennis_Toan_Dien__img20.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img20.png)
| 21 | Racket flip effortless — flip from elastic recoil ![Giai_Phau_Tennis_Toan_Dien__img21.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img21.png)
...
|
 Description | Image |
|---|---|---|
| 22 | Drive legs — knee flexed, push into ground ![Giai_Phau_Tennis_Toan_Dien__img22.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img22.png)
| 23 | Rotate hips — hip opens first, chest follows ![Giai_Phau_Tennis_Toan_Dien__img23.png](images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img23.png)
...
|---|---|---|
| `Human anatomy| `Human anatomy| `Tennis Knowledge/7.Tennis Books in pdf| Royal Veterinary College cheetah study | Cited in user's source DOCX | 70% body weight to hindlimb at 18 m/s, stride frequency vs length |
