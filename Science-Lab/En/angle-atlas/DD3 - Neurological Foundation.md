...
| 🇺🇸 English |
| --- |
| **What this deep dive covers** — The BRAIN side of tennis. How your eyes see the ball. How your brain decides what to do. How your body KNOWS where it is in space (proprioception). How fast your nerves actually fire. This is the neurology that lives behind every stroke. |
| **What this is NOT** — No "mental toughness" talk. No "confidence" advice. No focus or mindset. Those are psychological layers and they live in your existing deep dives (Mental Game, Pressure Management). **This chapter is pure neurology — anatomy of nerves, brain regions, and sensory systems.** |
| **Why this matters at 3.5 → 4.5** — Most recreational players train only their MUSCLES. They run, lift, do footwork. But the bottleneck for most 3.5 players is **reaction time** and **decision accuracy**, both of which are NEURAL limits, not muscular limits. Train the brain and the strokes get better for free. |
 # | Chapter | Chương |
|---|---|---|
...
| ![Vestibular 3D anatomy](images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img01.png) |
|

| ![Otoconia in vestibular system](images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img09.png) |
|
...
| Phase |---|---|---|
| **1. Wide perception ** | ~0.5 s before stroke | Soft eyes, gaze wide. Reads opponent's body, court, ball. |
|
 ~0.3 s before contact | Eyes narrow to the ball. Gaze centers. |
| **3. Narrow focus ** | ~0.1 s before contact | Gaze locks on the contact zone on opponent's racket. |
| **4. Quiet eye ** | **0.05–0.1 s** | Gaze FIXED on the contact point. **Eyes DO NOT MOVE.** This is the critical period. |
|
 ~0.2 s after contact | Gaze widens to track ball and read opponent's response. |

| ![Quiet eye focus](images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img15.png) |
...
|
 **Hình 3 & 4** — Mắt im lặng trong hành động (trái), và trình tự theo dõi 5 pha đầy đủ (phải). |
...
| Age |---|---|---|
|
 **~400 ms** | 100+ mph serve |
|
 **~500 ms** | 70–80 mph serve |
|
 **~600 ms** | 50–60 mph serve |
|
 **~700 ms** | <40 mph serve (recreational pace) |
...
|
 **Hình 5 & 6** — Thác phản xạ được hình dung (trái), và phản xạ thị giác lúc tiếp xúc (phải). |
...
| System |---|---|---|---|
| **Vision ** | ~10°–15° peripheral narrowing | ~20° narrowing, presbyopia | Tracking ball, judging depth |
| **Vestibular ** | ~20%–30% hair cell loss | ~40%–50% loss | Balance on rapid direction changes |
| **Proprioception ** | ~10%–15% accuracy loss | ~25%–30% accuracy loss | Spacing, recovery, court awareness |
...
|
 **Hình 7 & 8** — Bộ ba giác quan 50+ được hình dung (trái), và chiến lược bù (phải). |
...
| ![Foot proprioception - 7000 nerves](images/DD7_ankles_feet/DD7_ankles_feet_05.jpg) |
|
...
| Brain Region |---|---|---|
| **Occipital lobe ** | Visual processing | **Parietal lobe ** | Spatial mapping | **Temporal lobe ** | Pattern recognition | **Cerebellum ** |
 Makes the swing look smooth, not jerky |
| **Basal ganglia ** | Habit | **Prefrontal cortex ** | Decision |
 Balance 
...
| ![Neural pathway](images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img40.png) |
...
| See you on the court, with sharper eyes. |
| **Total concepts integrated from your source and the wider anatomy/neurology literature:** 45+ covering the 7-step reaction chain, the 5-phase visual cycle, the 3 reaction layers, the 7 brain regions, proprioception hardware, vestibular system, and neuroplasticity for 50+. |
